...
class SavedVideoGridView extends StatefulWidget {
  ...
  List file;
  int index;
  SavedVideoGridView({this.filePath='', required this.file , required this.index});
          ...
          children: [
            GestureDetector(
              onTap: (){
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context)=> VideoView(path: widget.filePath,isSaved: true,)));
